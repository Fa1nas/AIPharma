    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AiCachedAnswers",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    NormalizedQuestion = table.Column<string>(type: "varchar(300)", maxLength: 300, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiCachedAnswers", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WorkSchedule = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeSickLeaves", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeSickLeaves_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductStocks_Pharmacies_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "Pharmacies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSickLeaves_EmployeeId",
                table: "EmployeeSickLeaves",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkLogs_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductComparisons_UserId_ProductId",
                table: "ProductComparisons",
                columns: new[] { "UserId", "ProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_PharmacyId",
                table: "ProductStocks",
                column: "PharmacyId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_ProductId_PharmacyId",
                table: "ProductStocks",
